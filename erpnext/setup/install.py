...
default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://frappe.io/erpnext">UniERP</a></div>"""
...
def check_frappe_version():
	...
	click.secho(
		f"You're attempting to install UniERP version {erpnext_version} with Frappe version {frappe_version}. "
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "UniERP")
